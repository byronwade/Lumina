...
| Public-facing diagnostics reference | `docs/public/reference/diagnostics.md` summarizes planned diagnostic severity values, categories, shape, source paths, security rules, and source contract links. | Satisfied as planned docs |
