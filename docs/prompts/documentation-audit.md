...
Return findings ordered by impact. For each finding include the file, issue, recommended fix, priority, and whether README, AGENTS, status, roadmap, or reference docs need updates.
```
